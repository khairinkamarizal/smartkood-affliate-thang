...
const signupArtifact: Artifact = {
  name: 'SignupClaim',
  prompt: `Create an earnings-claim signup page that continues directly from the reward email. ${sharedBrief}\n\nUse one two-column card. Give the left summary the exact airy mesh treatment from the affiliate card: a warm white base with balanced diffused cyan, coral and tangerine radial light, never a purple wash or hard decorative shapes. Keep the existing welcome copy, an unclaimed-money label with a yellow signal dot and a large coral balance so blue does not dominate. Reserve Apple blue for the small brand mark and the primary form button. Keep the right form clean white with the three existing fields. Stack the columns on mobile. Do not add benefits, testimonials, or extra marketing copy. Associate every label and input and keep targets at least 44px.`,
...
.claim-summary { position:relative; display:flex; min-height:480px; overflow:hidden; flex-direction:column; padding:40px; background:radial-gradient(circle at 12% 0%,rgba(90,200,250,.55),transparent 36%),radial-gradient(circle at 100% 18%,rgba(255,59,107,.34),transparent 34%),radial-gradient(circle at 58% 115%,rgba(255,159,10,.38),transparent 40%),linear-gradient(145deg,#fff 8%,#f2f8ff 55%,#fff8ed 100%); color:#171419; }
.claim-summary h1,.claim-summary p,.claim-summary small,.claim-summary strong,.claim-summary b { position:relative; z-index:1; }.claim-summary h1 { margin:48px 0 0; font-size:44px; font-weight:600; line-height:1.05; letter-spacing:-.04em; }.claim-summary p { margin:16px 0 0; color:#69636d; }.claim-summary small { margin-top:auto; padding-top:56px; color:#5f5964; font-weight:600; letter-spacing:.075em; text-transform:uppercase; }.claim-summary strong { display:block; margin-top:10px; color:#ff3b6b; font-size:54px; font-weight:600; letter-spacing:-.055em; }
